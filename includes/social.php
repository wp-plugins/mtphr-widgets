...
function widget( $args, $instance ) {
	...
	if( isset($sites[0]) ) {
		...
		foreach( $sites as $site ) {
			echo '<a class="mtphr-social-widget-site mtphr-social-widget-'.$site['site'].' mtphr-hover-anim" href="'.esc_url($site['link']).'"'.$t.'>'.$site['site'].'<span class="mtphr-hover-anim-target"></span></a>';
		}
